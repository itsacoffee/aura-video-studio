...
export const ScriptProviders = [
  ...
  {
    value: 'OpenAI',
    label: 'OpenAI GPT-4 (Pro)',
    description: 'Cloud AI (GPT-4), fast response, requires API key',
    cost: 0.001,
    expectedLatency: 300,
    isLocal: false,
  },
  ...
  },
  {
    ...
    description: 'Cloud AI (Gemini), cost-effective, requires API key',
    cost: 0.0005,
    expectedLatency: 500,
    isLocal: false,
  },
  {
    ...
    description: 'Microsoft Azure cloud AI, requires credentials and deployment',
    cost: 0.01,
    expectedLatency: 300,
    isLocal: false,
  },
