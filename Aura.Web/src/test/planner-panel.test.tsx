...
describe('PlannerPanel', () => {
  ...
  it('should call onOutlineChange when outline is edited and saved', async () => {
    ...
    render(
      <PlannerPanel recommendations={mockRecommendations} onOutlineChange={onOutlineChange} />
    );
  ...
  it('should persist edited outline across edit sessions', async () => {
    ...
    rerender(
      <PlannerPanel recommendations={updatedRecommendations} onOutlineChange={onOutlineChange} />
    );
  ...
  it('should call onAccept when accept button is clicked', () => {
    ...
    render(<PlannerPanel recommendations={mockRecommendations} onAccept={onAccept} />);
  ...
  it('should show different quality labels based on score', () => {
    const scenarios = [
      ...
      { score: 0.8, label: 'Good' },
      { score: 0.72, label: 'Fair' },
      { score: 0.6, label: 'Basic' },
    ];
