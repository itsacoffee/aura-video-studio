 ...
 *
 * Manages timeline markers state including CRUD operations, navigation,
 * filtering, and export capabilities. Supports standard markers, chapter
 * markers, to-do markers, and beat markers.
 */
...
export interface OpenCutMarkersState {
  markers: Marker[];
...
export interface OpenCutMarkersActions {
  // CRUD operations
