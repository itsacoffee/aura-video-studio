...
class LearningService {
  ...
  async getPatterns(profileId: string): Promise<PatternsResponse> {
    const response = await apiClient.get<PatternsResponse>(
      `${this.baseUrl}/patterns/${profileId}`
    );
  ...
  async getInsights(profileId: string): Promise<InsightsResponse> {
    const response = await apiClient.get<InsightsResponse>(
      `${this.baseUrl}/insights/${profileId}`
    );
    return response.data;
  }
  ...
  async getPredictionStats(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/predictions/${profileId}`
    );
    return response.data;
  }
  ...
  async rankSuggestions(
    request: RankSuggestionsRequest
  ): Promise<{
    success: boolean;
    profileId: string;
  ...
  async getMaturityLevel(profileId: string): Promise<MaturityResponse> {
    const response = await apiClient.get<MaturityResponse>(
      `${this.baseUrl}/maturity/${profileId}`
    );
    return response.data;
  }
  ...
  async confirmPreference(
    ...
    const response = await apiClient.post(
      `${this.baseUrl}/confirm-preference`,
      request
    );
    return response.data;
  }
  ...
  async getInferredPreferences(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/preferences/${profileId}`
    );
    return response.data;
  }
  ...
  async getAnalytics(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/analytics/${profileId}`
    );
    return response.data;
  }
}
