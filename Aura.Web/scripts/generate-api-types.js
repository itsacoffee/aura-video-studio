...
try {
  ...
  console.log('✅ Swagger spec downloaded\n');
} catch (error) {
  console.error('❌ Failed to download swagger.json');
...
console.log('📝 Adding header comment to generated types...');
try {
...
`;
  ...
  console.warn('⚠️  Could not add header comment');
}

// Step 4: Create index.ts barrel export
console.log('📦 Creating barrel export...');
const indexContent = `/**
