...
Respond with ONLY the JSON object, no other text:";
    ...
    public Task<SceneCoherenceResult?> AnalyzeSceneCoherenceAsync(
        ...
        CancellationToken ct)
    {
        _logger.LogInformation("Scene coherence analysis not implemented for Gemini, returning null (will use fallback)");
    ...
    public Task<NarrativeArcResult?> ValidateNarrativeArcAsync(
        ...
        CancellationToken ct)
    {
        _logger.LogInformation("Narrative arc validation not implemented for Gemini, returning null (will use fallback)");
    ...
    public Task<string?> GenerateTransitionTextAsync(
        ...
        CancellationToken ct)
    {
        _logger.LogInformation("Transition text generation not implemented for Gemini, returning null (will use fallback)");
