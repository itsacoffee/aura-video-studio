...
Respond with ONLY the JSON object, no other text:";
    ...
    public Task<ContentComplexityAnalysisResult?> AnalyzeContentComplexityAsync(
        ...
        CancellationToken ct)
    {
        _logger.LogInformation("Content complexity analysis not implemented for Azure OpenAI, returning null (will use heuristics)");
    ...
    public Task<SceneCoherenceResult?> AnalyzeSceneCoherenceAsync(
        ...
        CancellationToken ct)
    {
        _logger.LogInformation("Scene coherence analysis not implemented for Azure OpenAI, returning null (will use fallback)");
    ...
    public Task<NarrativeArcResult?> ValidateNarrativeArcAsync(
        ...
        CancellationToken ct)
    {
        _logger.LogInformation("Narrative arc validation not implemented for Azure OpenAI, returning null (will use fallback)");
    ...
    public Task<string?> GenerateTransitionTextAsync(
        ...
        CancellationToken ct)
    {
        _logger.LogInformation("Transition text generation not implemented for Azure OpenAI, returning null (will use fallback)");
